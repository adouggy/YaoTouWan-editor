...
public class VideoPlayer implements MediaPlayer.OnPreparedListener, OnSeekBarChangeListener,
...
//    private WakeLock wakeLock;
    ...
    public VideoPlayer(Context ctx) {
        ...
        mPlayer.setOnCompletionListener((MediaPlayer.OnCompletionListener) ctx);
...
//        wakeLock = powerManager.newWakeLock(PowerManager.FULL_WAKE_LOCK, "MyMediaPlayer");
    ...
    private void setUpVideoDimensions() {
        ...
        if (videoProportion > screenProportion) {
            ...
            lp.height = (int) (lp.width / videoProportion);
        } else {
            lp.height = surfaceView.getHeight();
            lp.width = (int) (videoProportion * lp.height);
        }
